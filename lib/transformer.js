...
var keyboardjs_1 = require("keyboardjs");
...
var Transformer = /** @class */ (function () {
    ...
    Transformer.prototype.bindShotcuts = function () {
        var app = this.app;
        keyboardjs_1.default.bind("shift", function (e) {
            CAN_COMBINED = true;
        }, function (e) {
            CAN_COMBINED = false;
        });
        keyboardjs_1.default.bind("ctrl", function (e) {
            CAN_COMBINED = true;
        }, function (e) {
            CAN_COMBINED = false;
        });
        keyboardjs_1.default.bind("del", function (e) {
        });
        keyboardjs_1.default.bind("ctrl + z", function (e) {
        });
        keyboardjs_1.default.bind("ctrl + y", function (e) {
        });
        [
            "left",
            "right",
            ...
            keyboardjs_1.default.bind(e, function () {
            });
        });
        keyboardjs_1.default.bind("alt + g", function (e) {
        });
        var compose;
        // compose
        keyboardjs_1.default.bind("ctrl + g", function (e) {
        ...
        keyboardjs_1.default.bind("ctrl + shift + g", function (e) {
            Transformer.clearSelections();
